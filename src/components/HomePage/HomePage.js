...
function HomePage() {
  ...
  return (
    <div className={styles.homePage}>
      ...
      <p className={styles.intro}>This is a personal website of Shakhnazar</p>
      ...
      <div className={styles.info}>
        ...
        <div className={styles.info_item}>
          ...
          <div className={styles.location_content}>18</div>
        </div>
        <div className={styles.info_item}>
        ...
        <div className={styles.quiz_div}></div>
      </div>
      ...
      <div className="quiz-container">
        {showScore ? (
          <div className="score-section">
            ...
            {score === 4 && (
              <div>
                Great job! You got 4 out of 5 right. You really know a lot about
                me. We must be great friends!
              </div>
            )}
            {score === 3 && (
              <div>
                You scored 3 out of 5. Not bad at all! You know me pretty well,
                but there's always room to learn more about each other.
              </div>
            )}
            {score === 2 && (
              <div>
                You got 2 out of 5 right. Looks like you have some more to learn
                about me. Let's hang out more!
              </div>
            )}
            {score === 1 && (
              <div>
                You got 1 out of 5. Seems like you might not know me very well
                yet, but that's okay! There's plenty of time to change that.
              </div>
            )}
            {score === 0 && (
              <div>
